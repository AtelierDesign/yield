        ...
        <Container size="3">
          <Grid css={{ gridTemplateColumns: '2fr 1fr', gap: '$7' }}>
              ...
              <Box>
                ...
                <Box>
                  <Text css={{ lineHeight: '23px' }}>
                    A BATHING APE launched its brand new diffusion line, AAPE By A Bathing Ape (Aape for short), in 2012
                    with the aim to create a collection of simple, light clothes for everyday wear. Reviving the label’s
                    classic logo, it stamps a younger version of the original ape design across jersey T-shirts and
                    sweatpants with comfortable cuts.
                  </Text>
                </Box>
              </Box>
              <Box>
            ...
            <Box>
              ...
              <Box>
                <Text css={{ lineHeight: '23px' }}>
                  The Nike Sportswear Tech Fleece Full-Zip Hoodie is made from a double-sided spacer fabric for added
