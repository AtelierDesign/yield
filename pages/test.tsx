        ...
        <ScrollArea>
          ...
          <Section size="3">
            ...
            <Container size="2">
              <Box css={{ maxWidth: 525, mt: 100 }}>
                <Text size="5" variant="pink" css={{ mb: '$4', lineHeight: '25px', fontWeight: 500 }}>
                  Why Modulz
                </Text>
                ...
                <Text size="4" css={{ mb: '$3', lineHeight: '25px', pr: '$9' }}>
                  Almost all design tools are optimised for illustration. Drawing tools are great for exploration but
                  when it comes to designing websites, apps, and user interfaces, we need something more powerful.
                </Text>
                <Text size="3" variant="gray" css={{ lineHeight: '23px' }}>
                  It is exceptionally hard to have a great design tool that outputs useful code. Many have tried but in
                  the end the trade offs were too great. That was until Modulz made it their mission.
                </Text>
              </Box>
            </Container>
          </Section>
          ...
          <Section size="3">
            ...
            <Container size="2">
              ...
              <Paragraph css={{ mb: '$7' }}>
                Text should be aligned with the yellow box along the left edge. There's some optical shit going on here
                too, so this is not gospel.
              </Paragraph>
            </Container>
            <Container size="2">
          ...
          <Section size="3">
            ...
            <Container size="2">
              <Flex css={{ fd: 'column', gap: '$4' }}>
                <Heading css={{ color: '$gray12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$mauve12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$slate12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$red12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$crimson12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$pink12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$purple12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$violet12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$indigo12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$blue12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$cyan12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$teal12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$green12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$lime12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$yellow12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$orange12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$gold12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$brown12' }}>This heading look balanced and slightly saturated</Heading>
                <Heading css={{ color: '$bronze12' }}>This heading look balanced and slightly saturated</Heading>
              </Flex>
